...
var dataUrl = qry.match(new RegExp('dataUrl=' + "(.*)" + ''));
// var dataSources = [dataUrl[1], dataUrl[1]]; // api source 1, api source 2
var dataSources = ['js/entries.json', 'js/entries.json']; // api source 1, api source 2
var svgs = ['images/summary.svg']; // local svg images

var Deepviz = new Deepviz(dataSources, svgs, function(data){
